...
class Ui_d_ImportEtabs(object):
    def setupUi(self, d_ImportEtabs):
        if not d_ImportEtabs.objectName():
            d_ImportEtabs.setObjectName(u"d_ImportEtabs")
        ...
        icon = QIcon()
        icon.addFile(u":/Btn/etabs logo.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pb_OpenModel.setObjectName(u"pb_OpenModel")
        ...
        self.lb_ActiveModel.setObjectName(u"lb_ActiveModel")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.lb_ActiveModel.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, d_ImportEtabs):
        d_ImportEtabs.setWindowTitle(QCoreApplication.translate("d_ImportEtabs", u"Import Etabs", None))
        self.pb_Select.setText(QCoreApplication.translate("d_ImportEtabs", u"Select", None))
        self.pb_OpenModel.setText(QCoreApplication.translate("d_ImportEtabs", u"Open Model", None))
        self.groupBox.setTitle("")
        self.label.setText(QCoreApplication.translate("d_ImportEtabs", u"ACTIVE MODEL", None))
        self.lb_ActiveModel.setText("")
        self.label_3.setText(QCoreApplication.translate("d_ImportEtabs", u"Select active model or Open another model!", None))
    # retranslateUi
