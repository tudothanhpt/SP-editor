...
class Ui_d_BarSet(object):
    def setupUi(self, d_BarSet):
        if not d_BarSet.objectName():
            d_BarSet.setObjectName(u"d_BarSet")
        ...
        self.cb_BarSetList.setObjectName(u"cb_BarSetList")
        ...
        self.tbview_BarSet.setObjectName(u"tbview_BarSet")
    ...
    def retranslateUi(self, d_BarSet):
        d_BarSet.setWindowTitle(QCoreApplication.translate("d_BarSet", u"Bar Set", None))
        self.groupBox.setTitle(QCoreApplication.translate("d_BarSet", u"Reinforcement", None))
        self.label.setText(QCoreApplication.translate("d_BarSet", u"Bar set", None))
    # retranslateUi
