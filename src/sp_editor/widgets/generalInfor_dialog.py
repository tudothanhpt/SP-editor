...
class Ui_d_GeneralInfor(object):
    def setupUi(self, d_GeneralInfor):
        if not d_GeneralInfor.objectName():
            d_GeneralInfor.setObjectName("d_GeneralInfor")
        ...
        self.cb_DesignCode.setObjectName("cb_DesignCode")
        ...
        self.cb_UnitSystem.setObjectName("cb_UnitSystem")
        ...
        self.cb_BarSet.setObjectName("cb_BarSet")
        ...
        self.cb_Confinement.setObjectName("cb_Confinement")
        ...
        self.cb_SectionCapacity.setObjectName("cb_SectionCapacity")
    ...
    def retranslateUi(self, d_GeneralInfor):
        d_GeneralInfor.setWindowTitle(
            QCoreApplication.translate("d_GeneralInfor", "SP-editor", None)
        )
        self.pb_OK.setText(QCoreApplication.translate("d_GeneralInfor", "OK", None))
        self.pb_Cancel.setText(
            QCoreApplication.translate("d_GeneralInfor", "Cancel", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("d_GeneralInfor", "General", None)
        )
        self.label.setText(
            QCoreApplication.translate("d_GeneralInfor", "Design code", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("d_GeneralInfor", "Unit system", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("d_GeneralInfor", "Bar set", None)
        )
        self.label_4.setText(
            QCoreApplication.translate("d_GeneralInfor", "Confinement", None)
        )
        self.label_5.setText(
            QCoreApplication.translate("d_GeneralInfor", "Section capacity", None)
        )
