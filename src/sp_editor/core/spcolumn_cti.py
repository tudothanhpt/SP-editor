...
class CTIfile:
    ...
    def set_user_options(
        ...
        options = [
            ...
            column_type,
            confinement,
            load_type_investigation,
            load_type_design,
            reinforcement_layout_investigation,
            reinforcement_layout_design,
            num_irregular_bars,
            num_factored_loads,
            num_service_loads,
            num_points_exterior,
            ...
            reserved4,
            reserved5,
            cover_type_investigation,
            cover_type_design,
            num_load_combinations,
            section_capacity_method,
        ]
    ...
    def set_material_properties(
        ...
        standard_concrete_material = (
            0  # Standard material for concrete (0-Non-standard; 1-Standard)
        )
        standard_steel_material = (
            0  # Standard material for reinforcing steel (0-Non-standard; 1-Standard)
        )
    ...
    def set_reduction_factors(self, confinement_type: str = "Tied") -> None:
        ...
        if confinement_type == "Tied":
            ...
            tension_controlled_coeff = (
                0.9  # Option 2: Phi(b) for tension-controlled failure
            )
            compression_controlled_coeff = (
                0.650000  # Option 3: Phi(c) for compression-controlled failure
            )
        else:
            ...
            compression_controlled_coeff = (
                0.750000  # Option 3: Phi(c) for compression-controlled failure
            )
        # Option 4: Reserved. Do not edit
        option4 = 0.1
    ...
    def set_bar_group_type(self, bar_group_type: int = 1) -> None:
        ...
        """
        if (
            not isinstance(bar_group_type, int)
            or bar_group_type < 0
            or bar_group_type > 4
        ):
