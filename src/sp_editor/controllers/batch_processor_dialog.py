...
from sp_editor.core.read_batch_processor_outputs import (
    make_df_from_outputs,
    check_output_paths_exist,
    get_o_xlsx_paths_from_cti_paths,
    max_dcr_from_outputs,
)
...
class BatchProcessorDialog(qtw.QDialog, Ui_BatchProcessorDialog):
    ...
    def start_thread(self):
        ...
        self.thread = BatchProcessorThread(
            self.engine, self.input_files, options=ui_options
        )
        ...
        )  # Re-enable the start button when the thread finishes
        self.thread.start()
    ...
    def show_error(self, message):
        ...
        self.pb_startButton.setEnabled(
            True
