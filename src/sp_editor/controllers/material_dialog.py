...
from PySide6.QtWidgets import QApplication, QHeaderView, QTableView, QMessageBox
...
INITDATA_STEEL = {"name": [None], "fy": [None], "Es": [None], "ety": [None]}
...
class Material_Dialog(QtWidgets.QDialog, Ui_d_material):
    ...
    def __init__(self, engine: Engine, parent: QtWidgets.QWidget = None) -> None:
        ...
        for view, menu_func in [
            (self.tbview_concrete, self.on_context_menu),
    ...
    def save_dbdata_from_tableview(
        self, table_view: QTableView, table_name: str
    ) -> None:
