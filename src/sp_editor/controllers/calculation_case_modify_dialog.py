...
from crud.cr_load_case import (
    create_calculation_case,
    update_calculation_case,
    get_concrete_name_from_properties,
...
class CalculationCaseModify_Dialog(CalculationCase_Dialog):
    ...
    def __init__(
        ...
        self.concrete_name = get_concrete_name_from_properties(
            self.engine, self.material_fc, self.material_Ec
        )
        self.steel_name = get_steel_name_from_properties(
            self.engine, self.material_fy, self.material_Es
        )
