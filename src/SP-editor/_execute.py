import os
import spcolumn_cti, read_excel
import math
...
def main_multi(excelPath):
    ...
    spcolumn_filenames,numForceCombo,forceSet, acad_paths,lst_fc,lst_ec,lst_fy,lst_es = read_excel.get_SPRequiredData_fromExcel(excelPath)
