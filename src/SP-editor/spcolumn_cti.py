...
class CTIfile:
    ...
    def set_irregular_options(self)-> None:
        ...
        options = [option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12, option13]
    ...
    # Option 1: Reserved. Do not edit. 
        ...
        options = [option1, option2, option3, option4, option5, option6, option7, option8, option9, option10, option11, option12]
    ...
    def set_reinforcement_bars_auto(self,lst_PierSDShape,pierIndex,offset_distance,spacing,rebarArea)-> None:
        ...
        def calculate_rebarpoints_for_segments(lst_offsettedpolyline_points, spacing):
            ...
            for segment in segments:
                ...
                rounded_distance = math.sqrt((end_point[0] - start_point[0]) ** 2 + (end_point[1] - start_point[1]) ** 2)
                ...
                control_points = [(round(start_point[0] + i * x_diff, 5), round(start_point[1] + i * y_diff, 5)) for i in range(num_points)]
    ...
    def set_slenderness_column(self)-> None:
        ...
        SlendernessColumn_Xaxis = [columnclearheight,k_nonsway_X,k_sway_X,param4_X,param5,param6,param7,param8_X,param9_X]
        SlendernessColumn_Xaxis_string = ','.join(map(str, SlendernessColumn_Xaxis))
        SlendernessColumn_Yaxis = [columnclearheight,k_nonsway_Y,k_sway_Y,param4_Y,param5,param6,param7,param8_Y,param9_Y]
