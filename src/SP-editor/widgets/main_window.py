...
#endif // QT_CONFIG(shortcut)
        self.a_Cases.setText(QCoreApplication.translate("mw_Main", u"Cases", None))
        self.a_GetAllForce.setText(QCoreApplication.translate("mw_Main", u"Get All Force", None))
        self.a_MakeSPcolumn.setText(QCoreApplication.translate("mw_Main", u"Make SpColumn", None))
